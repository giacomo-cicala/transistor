...
\begin{abstract}
	Sono state svolte delle misure su un transistor BJT PNP in configurazione emettitore comune con correnti di base
	$I_{B}= \qty{-50}{\uA}$ e $I_{B}= \qty{-100}{\uA}$.
	...
	le conduttanze
	\begin{equation*}
		g_{50} = (0.43 \pm 0.05) \ \unit{\milli\siemens} \hspace{2cm} g_{100} = (1.05 \pm 0.07) \ \unit{\milli\siemens}
	\end{equation*}
...
L'obiettivo dell'esperimento è la misura di tensione di Early e fattore di
...
collettore con $I_b$ fissata. La conduttanza, definita
come:
\begin{equation}
...
transistor, compresa tra \qty{1}{\V} e \qty{3.5}{\V}. I valori dei parametri di
fit ottenuti per le due correnti di base sono:
\begin{equation*}
...
compatibilmente col fatto che la tensione di Early debba essere unica per tutte
le correnti, e che dunque la pendenza della retta della caratteristica in
